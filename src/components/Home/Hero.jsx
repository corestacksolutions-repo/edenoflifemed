...
const Hero = () => {
    return (
        <div className="w-full h-[90vh] overflow-hidden relative flex flex-col items-center justify-center bg-zinc-200">
            ...
            */}
            ...
            {/* Dark Overlay */}
            <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-zinc-50 via-zinc-50/50 to-transparent 05 z-10" />

            {/* Hero Content */}
            <div className="w-[92%] lg:w-[85%] flex flex-col items-start gap-3 z-20 text-white rounded-lg">

                <h1 className="md:text-7xl  font-semibold display text-sky-950">
                   Natural Medicine,<br/>
                   <span className="text">Holistic Healing</span>    
                </h1>
                ...
                <p className="font-body w-full md:w-[40%] font-semibold text-[1.3rem] text-sky-950/50">
                    A place to find natural, holistic, and personalized care that help you live a healthier and happier life.
                </p>
